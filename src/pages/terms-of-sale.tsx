  ...
  return (
    <div className="max-w-2xl mx-auto prose prose-blue">
      ...
      <p>
        ...
        wrong with your order, please let us know by contacting us at [insert
      ...
      <p>
        ...
        support@jbxclothing.ca with photos of wrong/damaged items and we&apos;ll
      ...
      <p>
        ...
        that&apos;s the case, please let us know at support@jbxclothing.ca within a
        week after receiving your order. Include your order number and photos of
        the mislabeled item, and we&apos;ll send you a new one, or issue a
        refund!
      </p>
    </div>
  );
